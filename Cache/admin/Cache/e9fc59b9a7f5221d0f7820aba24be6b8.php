...
<div id="nav" class="mainnav_title">
	<ul>
		<a class="on" href="<?php echo U('lists');?>">部门列表</a> |
		<a href="<?php echo U('add');?>">添加部门</a>
	</ul>
</div>
<form action="" method="get">
	<table class="search_table" width="100%">
		<tr>
			<td class="search">部门名称: <input id="names" type="text" class="input-text" name="names" value="<?php echo ($names); ?>"> &nbsp; <input type="submit" name="submit" value="查询" class="button">
			</td>
		</tr>
	</table>
</form>
<form name="myform" id="myform" action="" method="post">
	<div class="table-list">
		<table cellspacing="0" cellpadding="0" width="100%">
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="ulbc" id="tr_<?php echo ($vo["id"]); ?>">
					<td id="td_sel"><input type="checkbox" class="sel" id="sel_<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["id"]); ?>" name="deleteall[<?php echo ($vo["id"]); ?>]"></td>
					<td style="text-align: left;"><?php echo ($vo["names"]); ?></td>
					<td style="text-align: left;"><?php echo ($vo["code"]); ?></td>
					<td style="text-align: left;"><?php echo ($vo["comm"]); ?></td>
					<td><a
