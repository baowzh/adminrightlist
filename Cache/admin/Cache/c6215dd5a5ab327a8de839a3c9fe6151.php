...
<div id="nav" class="mainnav_title">
	<ul>
		<a class="on" href="<?php echo U('lists');?>">类别列表</a> |
		<a href="<?php echo U('add');?>">添加类别</a>
	</ul>
</div>
<form action="" method="get">
	<table class="search_table" width="100%">
		<tr>
			<td class="search">类别名称: <input id="names" type="text" class="input-text" name="names" value="<?php echo ($names); ?>"> &nbsp; <input type="submit" name="submit" value="查询" class="button">
			</td>
		</tr>
	</table>
</form>
